 ...
 *       vectores y aprovecha la posibilidad que ofrecen los compiladores de
 *       GCC y MinGW de declarar un vector de dimensión igual al resultado de
...
int main() {
    ...
    if (n > 0) {
        ...
        for (unsigned i = n - 1; i > 0; i--) {
            ...
            // el índice n - 1 y termina con 1. La componente indexada por 0
            // no la tratamos en este bucle simplemente para no poner una coma
